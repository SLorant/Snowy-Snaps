...
const Watch = () => {
  return (
    <div className="flex flex-col w-1/3 bg-gradient-to-b from-stone-700 to-cyan-100  h-80 rounded-t-2xl z-10  ">
        <WatchButton/>
        <div className="flex flex-col justify-center items-center">
        <img src="src/assets/huskygif.gif" alt="huskygif" className='shadow-lg max-h-36 my-2 rounded-full' />
