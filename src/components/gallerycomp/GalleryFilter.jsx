...
const GalleryFilter = ({ emotions, setOrder, emotionArray, setEmotionArray, setImgType }) => {
  ...
  return (
    <div className="flex w-full flex-col items-end md:w-3/4">
      <div
        className="flex w-full flex-col items-center  justify-center rounded-md bg-cream
        ...
        <div className={`${mobileFilterOpened ? 'flex' : 'hidden md:flex'}  flex-col  lg:w-1/6`}>
          <h2 className="mt-2 text-center font-header  text-3xl text-peach  md:my-2  xl:text-4xl">Sort by</h2>
          <div className="mt-2 mb-2 flex items-center justify-center gap-6 md:mb-3 md:flex-col md:gap-2 2xl:mt-0">
            <motion.p
              ...
              className={`${selectedSortType === 'asc' ? 'opacity-60' : 'opacity-100'}
            ...
            <motion.p
              ...
              className={`${selectedSortType === 'asc' ? 'opacity-100' : 'opacity-60'}
        ...
        <div className={`${mobileFilterOpened ? 'flex' : 'hidden md:flex'} flex-col`}>
          <h2 className="mt-4 text-center font-header text-3xl text-peach md:my-2  xl:text-4xl">Image type</h2>
          <div className="mt-2 mb-2 flex flex-row items-center justify-center gap-6 md:mb-3 md:flex-col md:gap-2 2xl:mt-0">
            <motion.p
              ...
              className={`${selectedImgType === 'picture' ? 'opacity-100' : 'opacity-60'}
            ...
            <motion.p
              ...
              className={`${selectedImgType === 'gif' ? 'opacity-100' : 'opacity-60'}
                cursor-pointer text-center font-header text-xl text-blue md:text-xl lg:text-2xl`}
              whileHover={{ scale: 1.15 }}>
              Gif
            </motion.p>
      ...
      <motion.p
        ...
        className={`${selectedImgType === '' && !emotionArray.length ? 'opacity-100' : 'opacity-60'}
