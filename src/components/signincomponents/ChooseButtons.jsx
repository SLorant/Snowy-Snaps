...
const ChooseButtons = () => {
  ...
  return (
    ...
    px-4 py-2 px-40 text-slate-800 font-hlight font-bold text-4xl transition ease-in-out duration-500 opacity-60 hover:opacity-100"
    whileHover={{ translateX : -25, transition: { duration: 0.1 }}}>Sign in</motion.button></Link>
    ...
    px-4 py-2 px-40 text-slate-800 font-hlight font-bold text-4xl opacity-60 hover:border-slate-700 hover:opacity-100
