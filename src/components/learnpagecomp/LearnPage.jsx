  ...
  return (
    <div className=" h-full w-full bg-cream">
      <div className=" flex  w-full flex-col items-center justify-center  bg-cream md:mt-16 ">
        ...
        <div className="fixed top-52 left-40 flex h-[500px] w-80 flex-col items-center justify-center rounded-md bg-white">
        ...
        <div className="mt-4 flex h-full w-5/12 flex-col items-center justify-start rounded-md bg-white">
          <h2 className=" mt-6 font-header text-4xl text-peach">Introduction</h2>
          <div
            id="spec"
            className="mx-20 mt-4 flex-col items-center justify-start text-justify font-body text-lg  text-blue">
            <p className="italic">
              {' '}
              Welcome to HuskyPedia! Please note that while I have done my best to provide accurate
              and up-to-date information, I am not an expert in the field. This is a hobby project
              and should be used for informational purposes only. If you are considering getting a
              husky or are a current owner, I strongly recommend consulting a professional trainer
              or veterinarian for personalized advice. Additionally, please take the time to check
              out the sources, as they contain more detailed and reliable information on the topic.
              Thanks for visiting!
            </p>
            <h2 className=" mt-4 text-center font-header text-4xl text-peach">Characteristics</h2>
            <img
            ...
            <div className=" mt-6 text-justify">
              ...
              over 10 years.
              <div className="mb-4" /> The females are thinner without any fragility of structure,
              ...
              <div className="mb-4" /> They have a thick double coat that reflects heat in the
              summer and shields them from the icy Arctic winter. They can have a variety of coat
              colors and patterns, but typically have white paws, legs, facial markings, and tail
              tips. Black and white coats are the most prevalent. Their almond-shaped eyes can have
              the following colors: brown, blue, or black. Sometimes, each of their eyes may be a
              distinct color.
            ...
            <div className="mt-4 text-justify">
              ...
              calorie intake as this can throw their diet out of balance. <div className="mb-4" />
              <div className="mx-8 mb-4 flex items-center  rounded-md bg-sand text-left ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-notes float-left mx-2 mb-2  w-1/3  grow"
                  width="60"
                  height="60"
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
              ...
              <div className="mt-4 text-justify">
                ...
                <div className="mx-8 mb-4 flex items-center  rounded-md bg-sand text-left ">
                  ...
                  <p className="my-3 mr-2 shrink leading-tight">
                    They are too long if you can hear them clicking on the floor. Cutting them too
                    short can result in bleeding, which may make your dog uncooperative the next
                    time the nail clippers are pulled out.
                  </p>
                </div>
              ...
              <div className="mt-4 text-justify">
                ...
                Make sure to provide them with a sizable, cozy dog bed so they can stretch out, roll
                over, and of course sleep.
                <div className="mb-4" />
                ...
                better for households without children or with teenagers. <div className="mb-4" />
              ...
              <div className="mt-4 text-justify">
                We need to be extra cautious when raising Siberian Husky puppies, especially during
                the weaning process. Do not overfeed puppies and follow a natural diet for them.
                After they have finished eating, you should 10 minutes before removing any leftover
                food.
                <div className="mb-4" />
                It's important to regularly feed them fresh food and to maintain their bowl clean.
                We can prevent potential illnesses this way. Try to stay away from any overly
                processed foods. This includes dog treats, BARNAwhich can be seriously detrimental
                to a puppy's health.
                <div className="mb-4" />
                ...
                to 60 minutes each day. <div className="mb-4" />
                Introduce different animals and people to your dog. A husky puppy will need
                socialization to become comfortable around people and other animals, just like any
                other dog. <div className="mb-4" />
                Due to their high dependence on their human companion and the need to settle into
                their new home, puppies require different sleeping arrangements than adult dogs.{' '}
                <div className="mb-4" id="exr" />
                When taking care of a puppy, you should start teaching them simple commands or
                habits, such as paper training. Professional training sessions may be a smart choice
                if your puppy appears uneasy or wary of other pets or people. These training
                sessions teach your dog how to behave among others.
              </div>
            </div>
            <h3 className=" mt-6 font-header text-3xl text-blue">Exercise</h3>
            <div className="mt-4 text-justify">
              Your Husky needs to exercise for at least two hours every day. To prevent them from
              getting bored, it's a good idea to space BARNA this out throughout the day and to
              change up your walking routes. The ideal scenario would also involve off-lead exercise
              in a safe environment. <div className="mb-4" />
              ...
              requirement is even more important. Therefore, we must give our Husky dogs a ton of
              toys to keep them occupied and take them on lengthy walks.
            </div>
            ...
            <div className="mt-4 text-justify">
              ...
              Siberian Huskies are intelligent working dogs, which makes training them simpler for
              us.
              <h3 className=" mt-6 font-header text-3xl text-blue">Potty</h3>
              <div className="mt-4 text-justify">
                To avoid accidents, watch your puppy closely when it is indoors. Constricting the
                dog to a specific area of your house makes this process easier. Make a loud noise
                and yell "no!" if you see your dog urinating or defecating indoors, then immediately
                take the dog outside.
                <div className="mb-4" />
                A puppy will require more trips to the potty than an older dog. Take the puppy
                outside as frequently as you can and on a regular basis to reduce the possibility of
                interior accidents. <div className="mb-4" id="crate" />
              ...
              <div className="mt-4 text-justify">
                Crate training is a great strategy to prevent damage to your house from huskies
                while your husky. Put your dog in its box with a treat or some kibble and a chew toy
                when you can't watch over it. The dog will eventually grow to appreciate being there
                and may even retreat there in times of stress.
                <div className="mb-4" />
                ...
                time after a day or so of doing this repeatedly. Then your dog can progress to
                spending longer times in the crate.
                <div className="mb-4" />
              ...
              <div className="mt-4 text-justify">
                You must train your husky to be cooperative when walking on a leash due to their
                desire to run off. <div className="mb-4" />
                If not on a leash, huskies can easily get lost. Put a collar on your dog while it is
                eating to help it become acclimated to it. The dog will grow accustomed to the
                collar and may even form pleasant associations with it.
                <div className="mb-4" id="clicker" />
                Start off by simply taking it for breef walks around the home, rewarding it with
                treats anytime it stays by your side and doesn't pull on the leash. When you've
                mastered that, try it outside! <div className="mb-4" />
              ...
              <div className="mt-4 text-justify">
                ...
                instruction by clicking the clicker and giving it a treat. Your dog learns more
                rapidly what you want it to perform when the sound is combined with a reward.{' '}
