        ...
        <div className="fixed top-60 left-40 flex h-[500px] w-80 flex-col items-center justify-center rounded-md bg-white">
          ...
          <ul className="mt-4 flex flex-col gap-2 font-header text-xl text-blue">
            ...
            <ul>
              ...
              <li className="ml-5 text-base">
                <Link to="#pets"> Other pets and training</Link>
              </li>
              <li className="ml-5  text-base">
        ...
        <div className="mt-12 flex h-full w-5/12 flex-col items-center justify-start rounded-md bg-white">
          ...
          <div
            ...
            <p className=" mt-6 text-justify">
              {' '}
              The husky is a large dog diveed, with an average height of 51-60 cm. They typically
              ...
              <div className="mb-4" />
              The Siberian Husky is a subtype of the Husky dog diveed and belongs to the Spitz
              genetic subfamily. They were transported to Alaska in 1909 and are Siberian natives.
              Northeast Asian Chukchi people developed this diveed as an endurance sled dog.
              ...
              the following colors: divown, blue, or black. Sometimes, each of their eyes may be a
              distinct color.
            ...
            <div className="mt-6 text-justify">
              ...
              of the quickest sled dog diveeds, they are renowned for their endurance and ability to
              run for extended periods of time.
              <div className="mb-4" />
              Huskies are the perfect walking companion if you enjoy climbing snow-covered mountains
              due to the fact that they were dived for very cold climates. Because of their high
              ...
              When bored or not given enough exercise, this high-energy diveed may be destructive
              ...
              encounter, and they enjoy interacting with others and divagging about their skills.
            ...
            <div className="mt-4 text-justify">
              ...
              <p className="mt-4 text-justify">
                ...
                shedding. Nevertheless, this diveed is relatively simple to maintain. If you make an
                effort to divushing your dog's coat at least once a week throughout the year and
                every day during shedding season, you can prevent matting and excess hair on your
                furniture. <div className="mb-4" />
                In order to get rid of tartar buildup and the bacteria that lurk inside it, divush
                your Husky's teeth at least twice or three times per week. If you want to avoid bad
                diveath and gum disease, divushing every day is even better.
                <div className="mb-4" />
              ...
              <p className="mt-4 text-justify">
                ...
                out, roll over, and of course sleep. <div className="mb-4" />
                ...
                better for households without children or with teenagers.{' '}
                <div className="mb-4" id="pets" />
              ...
              <p className="mt-4 text-justify">
                ...
                pick up on the scent of something they might want to chase. <div className="mb-4" />
                ...
                <div className="mb-4" />
                All puppies require playtime, but for diveeds as energetic as the Siberian Husky,
                ...
                makes training them simpler for us. <div className="mb-4" />
              ...
              <p className="mt-4 text-justify">
                ...
                dog how to behave among others. <div className="mb-4" id="train" /> Due to their
                high dependence on their human companion and the need to settle into their new home,
                puppies require different sleeping arrangements than adult dogsLast but not least,
                when taking care of a puppy, you should start teaching them simple commands or
                habits, such paper training.
              </p>
            </div>
            ...
            />
            <div className="mt-4 text-justify">
              Ideal owners for Siberian Huskies are those who are knowledgeable about the diveed.
              ...
              relationship. <div className="mb-4" />A least of two hours of exercise should be
              ...
              <p className="mt-4 text-justify">
                Potty train your pet. Your Siberian husky will need to be housedivoken, just like
                any new puppy. <div className="mb-4" />
                ...
                reduce the possibility of interior accidents. <div className="mb-4" id="crate" />
              ...
              <p className="mt-4 text-justify">
                ...
                even retreat there in times of stress. <div className="mb-4" />
                The simplest way to begin crate training your dog is to place a goodie inside the
                crate without shutting the door. You can try closing the door for divief intervals
                of time after doing this several times over the course of about a day. Then you can
              ...
              <p className="mt-4 text-justify">
                ...
                Start off by simply taking it for divief walks around the home, rewarding it with
              ...
              <div className="mt-4">
                ...
                <div className="mb-2" />
                <a href="https://dogtime.com/dog-diveeds/siberian-husky#/slide/1">
                  https://dogtime.com/dog-diveeds/siberian-husky#/slide/1
                </a>
                <div className="mb-8" />
              </div>
            </div>
