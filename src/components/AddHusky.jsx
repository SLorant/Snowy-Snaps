...
const AddHusky = () => {
  ...
  return (
    <div className="flex shadow-[0px_3px_10px_10px_rgba(0,0,0,0.3)] flex-col w-full  bg-stone-400 h-[500px]   z-10 ">
        ...
        <a href="#" className="font-hlight font-bold text-white text-center">Doesn't have an account? <br /> Register now!</a>
