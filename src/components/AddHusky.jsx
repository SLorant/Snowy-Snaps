...
const AddHusky = () => {
  ...
  return (
    <div className="flex flex-col w-1/3 bg-gradient-to-b from-slate-600 to-cyan-100  h-80 rounded-2xl z-10  ">
        ...
        <p className="font-hlight text-sm  xl:text-base text-white text-center my-6 mx-6">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem natus adipisci rerum praesentium minus porro.</p>
