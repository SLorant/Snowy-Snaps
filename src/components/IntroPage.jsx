...
const IntroPage = () => {
  return (
    <div className="flex my-4 z-10">
      
    <div className="flex flex-col justify-center items-center h-48 my-14  z-10 w-full ">
        <div className='h-32 bg-stone-700 absolute top-36 opacity-20 w-full'></div>
        <h1 className="font-hbold lg:my-5 mt-16 lg:mt-12 xl:mt-5   text-3xl mx-10 xl:mx-0
