    ...
    <div className="group relative top-0 left-0 flex cursor-pointer">
      <img
        className="relative top-1 left-10 z-10 h-48 w-48
         -rotate-3 rounded-md object-cover object-center drop-shadow-lg transition duration-500 ease-in-out
      ...
      />
      <img
        className="absolute left-4 top-4 z-20 h-48 w-48 rotate-2 rounded-md object-cover  object-center drop-shadow-lg
      ...
      />
      <img
        className="absolute  left-8 top-7 z-30  h-48 w-48 -rotate-2 rounded-md object-cover object-center drop-shadow-lg
      ...
      />
      <img
        className="absolute left-14 top-6 z-40 h-48 w-48 rotate-1 rounded-md object-cover object-center drop-shadow-lg
         transition duration-500 ease-in-out
