...
const ImageEditor = ({picture, setPicture, setFile, editor, isGallery}) => {
  ...
  return (
    <div className="fixed flex justify-center items-center top-0 left-0 w-full h-full bg-black/70 z-50">
            <div className='w-5/12 h-4/5 rounded-xl bg-white flex justify-center items-center'>
            ...
            />
            {isGallery && <button onClick={CropRatioChange}>change rectangle</button>}
