...
const ChooseButton = ({width, height, ratio, setHeight, setWidth, selected, setSelected, buttonwidth, buttonheight}) => {
  ...
  return (
    <motion.button
    key={ratio}
    className={`${selected === ratio ? buttonStyles.selected.className : buttonStyles.unselected.className} ${buttonStyles.common}`}
