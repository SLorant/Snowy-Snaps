...
const LeftForm = ({ onAdd }) => {
  ...
  return (
    ...
    <form className='left-form' onSubmit={onSubmit}>
        ...
        <input type="text" placeholder='Husky neve' value={text}
         onChange={(e) => setName(e.target.value)} />
        </div>
        <div className='form-group'>
        <label>Husky's birth</label>
        <input type="date" placeholder='Husky kora' value={age}
    ...
    { show ? <p id='hiddentext' style={{'display': display}}> Cute name!</p> : null }
