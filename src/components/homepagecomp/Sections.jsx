...
const WatchSection = lazy(() => import('./WatchSection'))
const LearnSection = lazy(() => import('./LearnSection'))
      ...
      <div className="relative flex flex-col items-center justify-center">
        <div
         ...
         shadow-[0px_0px_10px_5px_rgba(0,0,0,0.3)] dark:bg-sand sm:hidden">
          ...
          <img className=" mr-8 w-2/3 dark:hidden sm:hidden" src="/assets/icons/logocream.png" alt="logo" />
          <img className=" mr-8 hidden w-2/3 dark:block sm:hidden" src="/assets/icons/logo.png" alt="logo" />
