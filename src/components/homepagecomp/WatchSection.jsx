...
const WatchSection = () => {
  ...
  return (
    <div
      className=" relative z-30 flex grid w-full flex-col items-center justify-center justify-items-center bg-cream
     shadow-[0px_3px_10px_2px_rgba(0,0,0,0.3)] xl:grid-cols-2  xl:items-start  xl:justify-start  ">
      <div className="flex   w-full flex-col items-center  justify-center   xl:h-[1000px]">
        <div className=" flex   items-center justify-center ">
          <h2 className="mt-24 font-header text-4xl  text-blue   sm:mt-12 xl:text-4xl">Watch photos and gifs</h2>
        </div>

        <div className="flex w-full items-center justify-center">
          <ShowCaseImages move={move} setMove={setMove} />
        </div>
        <div className="mt-8 mb-28 flex items-center  justify-center drop-shadow-lg  md:mb-4 ">
      ...
      <div className="z-40 mt-6 flex hidden w-screen flex-col items-center bg-white md:flex xl:mt-0 xl:w-full xl:bg-cream">
