  ...
  return (
    <div className="flex flex-col items-center w-full bg-white shadow-[0px_3px_10px_2px_rgba(0,0,0,0.3)]  z-20  ">
      <div data-aos="fade-down" data-aos-offset="10" data-aos-once= "true" className="h-20   flex justify-center items-center">
       ...
       <img src="src/assets/huskyp2.jpg" alt="huskypic" className='ml-4 object-cover shadow-lg  xl:max-h-56 2xl:max-h-80 md:h-40 lg:h-48 xl:h-52 2xl:h-56 w-11/12 mt-8  rounded-2xl' />
       <img src="src/assets/huskygif.gif" alt="huskygif" className='ml-4 object-cover mt-8  mb-0 shadow-lg  2xl:max-h-80 md:h-40 lg:h-48 2xl:h-56 w-11/12  rounded-2xl' />
       <video controls alt="huskyvid" className=' mt-8 ml-4 object-cover shadow-lg h-52  2xl:max-h-80 h-56 md:h-40  lg:h-48 2xl:h-56  w-11/12  rounded-2xl'>
       <source src='src/assets/huskyvideo.mp4'  type="video/mp4"/>
       </video>
       <img src="src/assets/huskyp3.jpg" alt="huskypic" className='ml-4 object-cover shadow-lg h-52 2xl:max-h-80 h-60 md:h-40 lg:h-48 2xl:h-56 w-11/12 mt-8  rounded-2xl' />
       <img src="src/assets/huskywater.gif" alt="huskygif" className=' ml-4 object-cover mt-8 h-52 mb-0 shadow-lg md:h-40 lg:h-48 2xl:max-h-80 2xl:h-56 w-11/12  rounded-2xl' />
       
       <video controls alt="huskyvid" className='mt-8 ml-4 object-cover shadow-lg h-52 2xl:max-h-80 h-60 md:h-40 2xl:h-56 lg:h-48 w-11/12  rounded-2xl'>
